...
const services = [
  {
    ...
    icon: TreePine,
    color: "text-red-400",
    glow: "hover:shadow-[0_0_50px_-12px_rgba(127,29,29,0.5)]",
    image: "/images/service_tree_removal.jpg",
  },
  {
    ...
    image: "/images/service_stump_grinding.jpg",
  },
  {
    ...
    image: "/images/service_trimming.jpg",
  },
  {
    title: "Yard Cleanups",
    ...
    glow: "hover:shadow-[0_0_50px_-12px_rgba(148,163,184,0.5)]",
    image: "/images/service_yard_cleanup.jpg",
  },
];
    ...
    <section id="services" className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-20 p-12 rounded-[2.5rem] bg-forest text-white relative overflow-hidden"
        >
          ...
          {services.map((service, index) => (
            ...
            >
              <Link
                to={service.link}
                className={cn(
                  "group block relative overflow-hidden rounded-[3rem] h-full min-h-[380px]",
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-end h-full p-10 lg:p-14">
                  ...
                  <h3 className="text-3xl font-display font-bold text-white mb-4 group-hover:text-safety transition-colors tracking-tight">
                    {service.title}
                  </h3>
