...
export function Footer() {
  ...
  return (
    <footer className="bg-neutral-900 text-white pt-24 pb-12 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20 relative z-10">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/people/Simpson-Sons-Tree-Service/100087185520117/?rdid=3W214dFvX2tJsji7&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F15hYPBHcWR%2F" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-safety transition-colors">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-4 text-neutral-400 text-sm">
            ...
            <li><Link to="/contact" className="hover:text-safety transition-colors">Contact Us</Link></li>
        ...
        <div>
          ...
          <ul className="flex flex-col gap-6">
            ...
            <li className="flex items-start gap-4 group">
              <div className="min-w-10 min-h-10 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-safety transition-colors">
                <Mail className="w-5 h-5" />
              </div>
              <div>
                <p className="text-xs text-neutral-500 uppercase tracking-widest font-bold mb-1">Email Us</p>
                <a href="mailto:Simpsonandsonstreeservice@gmail.com" className="text-white text-sm font-bold hover:text-safety transition-colors">Simpsonandsonstreeservice@gmail.com</a>
              </div>
            </li>
          </ul>
        </div>
